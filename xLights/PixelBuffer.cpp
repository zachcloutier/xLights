...
void PixelBufferClass::RenderFountain(int fountainHeight, int numParticles, int sprayRate, int sprayAngle) {
    effects[CurrentLayer].RenderFountain(fountainHeight, numParticles, sprayRate, sprayAngle);
}
